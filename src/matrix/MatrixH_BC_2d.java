...
public class MatrixH_BC_2d extends Matrix{
    ...
    private double[][][] N; /*= {
            {{(0.25*(1-ksiEta[0][0][0])*(1-ksiEta[0][0][1])), (0.25*(1+ksiEta[0][0][0])*(1-ksiEta[0][0][1])), (0.25*(1+ksiEta[0][0][0])*(1+ksiEta[0][0][1])), (0.25*(1-ksiEta[0][0][0])*(1+ksiEta[0][0][1]))}
            ,{(0.25*(1-ksiEta[0][1][0])*(1-ksiEta[0][1][1])), (0.25*(1+ksiEta[0][1][0])*(1-ksiEta[0][1][1])), (0.25*(1+ksiEta[0][1][0])*(1+ksiEta[0][1][1])), (0.25*(1-ksiEta[0][1][0])*(1+ksiEta[0][1][1]))}},
            {{(0.25*(1-ksiEta[1][0][0])*(1-ksiEta[1][0][1])), (0.25*(1+ksiEta[1][0][0])*(1-ksiEta[1][0][1])), (0.25*(1+ksiEta[1][0][0])*(1+ksiEta[1][0][1])), (0.25*(1-ksiEta[1][0][0])*(1+ksiEta[1][0][1]))}
            ,{(0.25*(1-ksiEta[1][1][0])*(1-ksiEta[1][1][1])), (0.25*(1+ksiEta[1][1][0])*(1-ksiEta[1][1][1])), (0.25*(1+ksiEta[1][1][0])*(1+ksiEta[1][1][1])), (0.25*(1-ksiEta[1][1][0])*(1+ksiEta[1][1][1]))}},
            {{(0.25*(1-ksiEta[2][0][0])*(1-ksiEta[2][0][1])), (0.25*(1+ksiEta[2][0][0])*(1-ksiEta[2][0][1])), (0.25*(1+ksiEta[2][0][0])*(1+ksiEta[2][0][1])), (0.25*(1-ksiEta[2][0][0])*(1+ksiEta[2][0][1]))}
            ,{(0.25*(1-ksiEta[2][1][0])*(1-ksiEta[2][1][1])), (0.25*(1+ksiEta[2][1][0])*(1-ksiEta[2][1][1])), (0.25*(1+ksiEta[2][1][0])*(1+ksiEta[2][1][1])), (0.25*(1-ksiEta[2][1][0])*(1+ksiEta[2][1][1]))}},
            {{(0.25*(1-ksiEta[3][0][0])*(1-ksiEta[3][0][1])), (0.25*(1+ksiEta[3][0][0])*(1-ksiEta[3][0][1])), (0.25*(1+ksiEta[3][0][0])*(1+ksiEta[3][0][1])), (0.25*(1-ksiEta[3][0][0])*(1+ksiEta[3][0][1]))}
            ,{(0.25*(1-ksiEta[3][1][0])*(1-ksiEta[3][1][1])), (0.25*(1+ksiEta[3][1][0])*(1-ksiEta[3][1][1])), (0.25*(1+ksiEta[3][1][0])*(1+ksiEta[3][1][1])), (0.25*(1-ksiEta[3][1][0])*(1+ksiEta[3][1][1]))}}};
*/
    private double[][][][] N_NT;
    private double[][][][] sum;
